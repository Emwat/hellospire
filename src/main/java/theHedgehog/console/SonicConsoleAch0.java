...
import static com.megacrit.cardcrawl.unlock.UnlockTracker.retroactiveUnlock;
...
public class SonicConsoleAch0 extends ConsoleCommand {
    public SonicConsoleAch0() {
    ...
    protected void execute(String[] tokens, int depth) {
        ...
        if (subcommand.equals("retro")){
            com.megacrit.cardcrawl.unlock.UnlockTracker.retroactiveUnlock();
