...
public class ModMindblastEffect extends AbstractGameEffect {
    private float x;
    private float y;
    ...
    public ModMindblastEffect(float x, float y, boolean flipHorizontal, boolean playSound) {
        if (img == null) {
    ...
    public ModMindblastEffect(float x, float y, boolean flipHorizontal) {
        this(x, y, flipHorizontal, false);
    }
