...
public class SuperSonicParticleEffect extends AbstractGameEffect {
    ...
    public SuperSonicParticleEffect(float x, float y) {
        this.renderBehind = MathUtils.randomBoolean();
        this.x = x;
        this.y = y;
        this.color = Settings.LIGHT_YELLOW_COLOR.cpy();
        this.img = ImageMaster.LIGHTNING_PASSIVE_VFX.get(this.index);
        this.scale = random(0.8F, 1.2F) * Settings.scale;
        this.rotation = random(360.0F);
        ...
        this.intervalDuration = random(0.03F, 0.06F);
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(this.img,
                ...
                this.y - 61.0F,
                61.0F, 61.0F,
                122.0F, 122.0F, this.scale, this.scale, this.rotation, 0, 0, 122, 122, this.flipX, this.flipY);
