...
public class DevTogether extends CustomMultiplayerCard {
    ...
    public DevTogether(String id, String name, String img, int cost, String rawDescription, CardType type, CardColor color, CardRarity rarity, CardTarget target) {
