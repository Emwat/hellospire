...
public class ModLagavulin extends AbstractMonster {
    private static final Logger logger = LogManager.getLogger(ModLagavulin.class.getName());
    public static final String ID = "ModLagavulin";
    // private static final MonsterStrings monsterStrings;
    public static final String NAME = "Lagavulin";
    public static final String[] DIALOG = new String[] { "", "... NL .....", "...? NL .....!?", "@!!!@ NL @!???@" };
    ...
    private static final String DEBUFF_NAME = "Siphon Soul";
