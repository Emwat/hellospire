...
public class SkinSystemPatches {
    ...
    public static class RenderSkinSelection {
        ...
        public static void patch(CharacterOption __instance, SpriteBatch sb) {
            if (__instance.c instanceof Sonic && __instance.selected) {
    ...
    public static class PopulateCache {
        ...
        public static void catchAtlas(AbstractCreature __instance, String atlasUrl) {
            if (__instance instanceof Sonic) {
                atlasCache.putIfAbsent(atlasUrl, ((Sonic) __instance).getAtlas());
            }
        }
        ...
        public static class AtlasNewExprEditor extends ExprEditor {
            ...
            public static boolean hasAtlas(String atlasUrl, AbstractCreature instance) {
                return instance instanceof Sonic && atlasCache.containsKey(atlasUrl);
            }
    ...
    public static class FixNullUnsafeCall {
        ...
        public static class SetImageEditor extends ExprEditor {
            ...
            public static boolean isSonic(AbstractPlayer instance) {
                return instance instanceof Sonic;
            }
        }
    }
}