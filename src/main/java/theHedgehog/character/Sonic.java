...
public class Sonic extends CustomPlayer {
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass THE_HEDGEHOG;
        @SpireEnum(name = "HEDGEHOG_BLUE25") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "HEDGEHOG_BLUE25")
    ...
    public ArrayList<String> getStartingRelics() {
        ...
        } else if (MyModConfig.optionStarterRelic == 3) {
            retVal.add(CrackedCore.ID);
        } else if (MyModConfig.optionStarterRelic == 4) {
            retVal.add(PureWater.ID);
    ...
    private final Color cardRenderColor = Color.BLUE.cpy(); // Used for some vfx on moving cards (sometimes) (maybe)
    private final Color cardTrailColor = Color.BLUE.cpy(); // Used for card trail vfx during gameplay.
    ...
    public void updateVictoryVfx(ArrayList<AbstractGameEffect> effects) {
        ...
        for (float i = 0; i + (1.0 / 30.0) <= update_timer; update_timer -= (1.0 / 30.0)) {
            effects.add(new VictoryStarEffect());
        }
    }
