...
//     public static class addBonusScorePatch {
//         @SpirePostfixPatch
//         public static void addBonusScorePatch(VictoryScreen __instance) {
//             String classicModeDescription = CardCrawlGame.languagePack.getScoreString(makeID("ClassicMode")).DESCRIPTIONS[0];
//             ArrayList<GameOverStat> stats = ReflectionHacks.getPrivate( __instance, VictoryScreen.class, "stats");
//             int ascensionPoints = AbstractDungeon.ascensionLevel * 10;
//
//             stats.add(new GameOverStat("ASCENSION (" + AbstractDungeon.ascensionLevel + ")", classicModeDescription, Integer.toString(ascensionPoints)));
//         }
//     }
// }