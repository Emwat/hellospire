...
//
// public class BattleSonicBlue extends AbstractSkin {
//
//     public BattleSonicBlue() {
//         // this.NAME = CardCrawlGame.languagePack.getUIString("reskinContent:ReSkin").TEXT[1];
//         ModSkinDictionary.ModSkin modSkin = ModSkinDictionary.getModSkin(SonicMod.makeID("skinBattleSonicBlue"));
