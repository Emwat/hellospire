// package hellospire.reskinContent.skinCharacter.skins.Sonic;
//
...
//
// public class BattleSonicGreen extends AbstractSkin {
//
//     public BattleSonicGreen() {
//         // this.NAME = CardCrawlGame.languagePack.getUIString("reskinContent:ReSkin").TEXT[1];
//         ModSkinDictionary.ModSkin modSkin = ModSkinDictionary.getModSkin(SonicMod.makeID("skinBattleSonicGreen"));
...
//         this.SHOULDER2 = SonicMod.characterPath("shoulder10.png");
//         this.CORPSE = SonicMod.characterPath("corpse.png");;
