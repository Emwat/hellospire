...
//
// public class BattleSonicRed extends AbstractSkin {
//
//     public BattleSonicRed() {
//         // this.NAME = CardCrawlGame.languagePack.getUIString("reskinContent:ReSkin").TEXT[1];
//         ModSkinDictionary.ModSkin modSkin = ModSkinDictionary.getModSkin(SonicMod.makeID("skinBattleSonicRed"));
