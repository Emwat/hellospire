...
//
// public class BattleKnuckles extends AbstractSkin {
//
//     public BattleKnuckles() {
//         // this.NAME = CardCrawlGame.languagePack.getUIString("reskinContent:ReSkin").TEXT[1];
//         ModSkinDictionary.ModSkin modSkin = ModSkinDictionary.getModSkin(SonicMod.makeID("skinBattleKnuckles"));
