...
import hellospire.cards.SpinDash;
...
import static hellospire.powers.OneUpPower.reviveAmount;
import static hellospire.relics.CDPastRelic.reviveCost;
...
public class TimeStoneEvent extends PhasedEvent {
    ...
    private void Option020_Future_Commit(Integer i) {
        ...
        if (Loader.isModLoaded("anniv5") && AbstractDungeon.player instanceof ThePackmaster) {
            homingAttack = new hellospire.cardsPackExclusive.HomingAttack();
        }
