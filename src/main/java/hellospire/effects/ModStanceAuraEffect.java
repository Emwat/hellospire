...
import hellospire.stances.FireStance;
import hellospire.stances.IceStance;

public class ModStanceAuraEffect extends AbstractGameEffect {
    private float x;
    private float y;
    private float vY;
