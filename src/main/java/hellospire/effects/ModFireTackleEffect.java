...
public class ModFireTackleEffect extends AbstractGameEffect {
    private float x;
    private float y;
    ...
    public ModFireTackleEffect(float x, float y) {
        this.duration = 0.5F;
        this.x = x;
        this.y = y;
    ...
    public void update() {
        ...
        float tmp = Interpolation.fade.apply(-209.0F, 30.0F, this.duration / 0.5F) * ((float)Math.PI / 180F);
