...
public class GainedRicochetPower extends BasePower {
    public static final String POWER_ID = makeID("GainedRicochet");
    private static final PowerType TYPE = PowerType.BUFF;
    private static final boolean TURN_BASED = false;

    public GainedRicochetPower(AbstractCreature owner) {
